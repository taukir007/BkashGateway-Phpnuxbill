    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-primary panel-hovered panel-stacked mb30">
                <div class="panel-heading">bKash Tokenizer Settings By Taukir</div>
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-md-2 control-label">Environment</label>
                        <div class="col-md-6">
                            <select class="form-control" id="bkash_environment" name="bkash_environment">
                                <option value="sandbox" {if $_c['bkash_environment'] == 'sandbox'}selected{/if}>Sandbox</option>
                                <option value="live" {if $_c['bkash_environment'] == 'live'}selected{/if}>Live</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
